...
$('#myTable').DataTable({
    ...
    'columnDefs': [
        ...
        {
            data: null,
            defaultContent: '<form action="assigned-appointment-worker-view.php" id="addAppoitment" method="get"><input id="appointmentId" hidden type="text" name="appointmentId" value=""></form><button form="addAppoitment" class="btn my-btn-view mx-1" id="actionClick">View</button>',
            targets: -1
        },
    ],
});
