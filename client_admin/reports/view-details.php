...
require_once "../php/report-view-details.php";
?>
...
<body>
    ...
    <div class="wrapper">
                ...
                <div class="container-fluid" id="appointmentArea">
                    <div class="container-fluid" id="subArea-bottom">
                        ...
                        <div class="mt-5 row d-flex justify-content-between">
                            <div class="mb-3 col-xxl-4 row">
                                <div class="mb-4 col-xxl">
                                    <button type="button" name="submitReport" data-bs-toggle="modal" data-bs-target="#approveReportModal" class="w-100 btn my-button-yes">Approve Report</button>
                                </div>
                                <div class="mb-4 col-xxl">
                                    <button type="button" name="updateReport" data-bs-toggle="modal" data-bs-target="#submitReportModal" class="w-100 btn my-button-no">Update Report</button>
                                </div>
                            </div>
                            <div class="mb-4 col-xxl-2">
                                <button type="button" name="submitReport" data-bs-toggle="modal" data-bs-target="#deleteReportModal" class=" w-100 btn my-button-danger">Delete Report</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="../js/disable-enter.js"></script>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow p-3 mb-5 bg-white rounded border">
            ...
            <div class="modal-footer">
                <button name="updateReport" form="reportDetails" class="btn my-button-yes">Confirm</button>
...
<div class="modal fade" id="approveReportModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="approveReportModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow p-3 mb-5 bg-white rounded border">
            <div class="modal-header">
                <h1 class="modal-title" style="font-size: 20px;" id="exampleModalLabel">Approve Report?</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button name="approveReport" form="reportDetails" class="btn my-button-yes">Confirm</button>
                <button type="button" class="btn my-button-no" data-bs-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="deleteReportModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="deleteReportModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow p-3 mb-5 bg-white rounded border">
            <div class="modal-header">
                <h1 class="modal-title" style="font-size: 20px;" id="exampleModalLabel">Delete Report?</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button name="deleteReport" form="reportDetails" class="btn my-button-danger">Confirm</button>
                <button type="button" class="btn my-button-no" data-bs-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
