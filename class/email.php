...
class Email
{
    public function sendForgotPasswordLink($email, $token, $typeCustomer)
    {
        global $typeUrl;
        if ($typeCustomer == "client_customer") {
            $typeUrl = "customer";
        } elseif ($typeCustomer == "employee") {
            $typeUrl = "employee";
        } else {
            $typeUrl = "peaksched";
        }
                                        ...
                                        <tr>
                                            ...
                                            <table class="btn btn-primary p-3 fw-700" role="presentation" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="https://$typeUrl.tphc-maintenance.com/peaksched/$typeCustomer/reset_password.php?token=$token"
