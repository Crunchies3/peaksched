                ...
                <div class="container-fluid" id="subArea-top">
                    ...
                    <div class="row">
                        <div class="mb-3 col-xxl-3">
                            <button data-bs-toggle="modal" data-bs-target="#updateInfoModal" class="btn btn-sm fs-6 w-100 my-button-yes">Save changes</button>
                        </div>
                        <div class="mb-0 col-xxl-3">
                            <a href="./setting_account_page.php" name="discardChanges" class="btn btn-sm fs-6 w-100 my-button-no">Discard changes</a>
                        </div>
                    </div>
                </div>
