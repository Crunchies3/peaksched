        ...
        <div class="row box-area shadow-lg">
            ...
            <div class="col-lg-6 right-box">
                <div class="row align-items-center">
                    ...
                    <form class="g-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="emailForm" novalidate>
                        ...
                        <div class="input-group mb-5">
                            <button id="btnSubmit" type="submit" class="btn btn-lg w-100 fs-6" style="background-color: #124F6F; color: whitesmoke; font-weight: 600;">Send
                            </button>
                        </div>
